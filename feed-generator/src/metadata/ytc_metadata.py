    ...
    def _parse_from_dict(data: Any) -> ChannelInformation:
        def banner_url_eval():
            if "c4TabbedHeaderRenderer" in data["header"]:
                ...
                return data["header"]["c4TabbedHeaderRenderer"]["banner"]["thumbnails"][
                    0
                ]["url"]
        ...
        return ChannelInformation(
            ...
            profile_pic_hash=download_encode_and_hash(
                data["metadata"]["channelMetadataRenderer"]["avatar"]["thumbnails"][0][
                    "url"
                ]
            ),
            profile_banner_hash=ChannelInformationGetter._fail_key_error_silently(
